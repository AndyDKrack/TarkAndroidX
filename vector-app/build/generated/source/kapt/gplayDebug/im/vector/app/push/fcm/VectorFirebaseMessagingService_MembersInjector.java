...
public final class VectorFirebaseMessagingService_MembersInjector implements MembersInjector<VectorFirebaseMessagingService> {
  ...
  public static MembersInjector<VectorFirebaseMessagingService> create(
      ...
      Provider<UnifiedPushHelper> unifiedPushHelperProvider,
      Provider<MdmService> mdmServiceProvider) {
    return new VectorFirebaseMessagingService_MembersInjector(fcmHelperProvider, vectorPreferencesProvider, activeSessionHolderProvider, pushersManagerProvider, pushParserProvider, vectorPushHandlerProvider, unifiedPushHelperProvider, mdmServiceProvider);
  }
  ...
  public void injectMembers(VectorFirebaseMessagingService instance) {
    ...
    injectMdmService(instance, mdmServiceProvider.get());
  }
  ...
  @InjectedFieldSignature("im.vector.app.push.fcm.VectorFirebaseMessagingService.mdmService")
  public static void injectMdmService(VectorFirebaseMessagingService instance,
      MdmService mdmService) {
    instance.mdmService = mdmService;
  }
}
