...
public final class VectorApplication_MembersInjector implements MembersInjector<VectorApplication> {
  ...
  public VectorApplication_MembersInjector(
      ...
      Provider<DecryptionFailureTracker> decryptionFailureTrackerProvider,
      ...
      Provider<WebRtcCallManager> webRtcCallManagerProvider) {
    ...
    this.decryptionFailureTrackerProvider = decryptionFailureTrackerProvider;
    ...
    this.webRtcCallManagerProvider = webRtcCallManagerProvider;
  }
  ...
  public void injectMembers(VectorApplication instance) {
    ...
    injectDecryptionFailureTracker(instance, decryptionFailureTrackerProvider.get());
    ...
    injectWebRtcCallManager(instance, webRtcCallManagerProvider.get());
  }
  ...
  @InjectedFieldSignature("im.vector.app.VectorApplication.decryptionFailureTracker")
  public static void injectDecryptionFailureTracker(VectorApplication instance,
      DecryptionFailureTracker decryptionFailureTracker) {
    instance.decryptionFailureTracker = decryptionFailureTracker;
  }
  ...
  public static void injectWebRtcCallManager(VectorApplication instance,
      WebRtcCallManager webRtcCallManager) {
    instance.webRtcCallManager = webRtcCallManager;
  }
}
