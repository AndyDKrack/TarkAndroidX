...
public final class VectorApplication extends android.app.Application implements androidx.work.Configuration.Provider {
    ...
    @javax.inject.Inject()
    public im.vector.app.features.analytics.DecryptionFailureTracker decryptionFailureTracker;
    @javax.inject.Inject()
    ...
    @javax.inject.Inject()
    public im.vector.app.features.call.webrtc.WebRtcCallManager webRtcCallManager;
    ...
    @org.jetbrains.annotations.NotNull()
    public final im.vector.app.features.analytics.DecryptionFailureTracker getDecryptionFailureTracker() {
        return null;
    }
    
    public final void setDecryptionFailureTracker(@org.jetbrains.annotations.NotNull()
    im.vector.app.features.analytics.DecryptionFailureTracker p0) {
    }
    ...
    @org.jetbrains.annotations.NotNull()
    public final im.vector.app.features.call.webrtc.WebRtcCallManager getWebRtcCallManager() {
        return null;
    }
    
    public final void setWebRtcCallManager(@org.jetbrains.annotations.NotNull()
    im.vector.app.features.call.webrtc.WebRtcCallManager p0) {
    }
