...
import im.vector.app.core.utils.AndroidPermissionChecker;
...
public final class DaggerVectorApplication_HiltComponents_SingletonC {
  ...
  private static final class FragmentCImpl extends VectorApplication_HiltComponents.FragmentC {
    ...
    private SelfVerificationController selfVerificationController() {
      return new SelfVerificationController(singletonCImpl.stringProvider(), singletonCImpl.colorProvider(), singletonCImpl.eventHtmlRendererProvider.get());
    }

    private UserVerificationController userVerificationController() {
      return new UserVerificationController(singletonCImpl.stringProvider(), singletonCImpl.colorProvider(), singletonCImpl.eventHtmlRendererProvider.get());
    }
    ...
    private ElementCallItemFactory elementCallItemFactory() {
      return new ElementCallItemFactory(singletonCImpl.session(), activityCImpl.userPreferencesProvider(), activityCImpl.messageColorProvider(), messageInformationDataFactory(), messageItemAttributesFactory(), avatarSizeProvider(), noticeItemFactory());
    }
    ...
    private GalleryOrCameraDialogHelperFactory galleryOrCameraDialogHelperFactory() {
      return new GalleryOrCameraDialogHelperFactory(singletonCImpl.colorProvider(), singletonCImpl.providesDefaultClockProvider.get());
    }
    ...
    private SearchResultController searchResultController() {
      return new SearchResultController(singletonCImpl.session(), singletonCImpl.avatarRendererProvider.get(), singletonCImpl.stringProvider(), singletonCImpl.vectorDateFormatter(), singletonCImpl.displayableEventFormatter(), activityCImpl.userPreferencesProvider(), singletonCImpl.providesDefaultClockProvider.get());
    }
    ...
    private ViewEditHistoryEpoxyController viewEditHistoryEpoxyController() {
      return new ViewEditHistoryEpoxyController(singletonCImpl.stringProvider(), singletonCImpl.colorProvider(), singletonCImpl.eventHtmlRendererProvider.get(), singletonCImpl.vectorDateFormatter(), singletonCImpl.providesDefaultClockProvider.get());
    }
    ...
    private HomeFilteredRoomsController homeFilteredRoomsController() {
      return new HomeFilteredRoomsController(roomSummaryItemFactory(), singletonCImpl.fontScalePreferencesImpl(), new RoomSummaryRoomListDiffCallback());
    }
    ...
    private LiveLocationBottomSheetController liveLocationBottomSheetController() {
      return new LiveLocationBottomSheetController(singletonCImpl.avatarRendererProvider.get(), singletonCImpl.vectorDateFormatter(), singletonCImpl.stringProvider(), singletonCImpl.providesDefaultClockProvider.get());
    }
    ...
    private DeviceTrustInfoEpoxyController deviceTrustInfoEpoxyController() {
      return new DeviceTrustInfoEpoxyController(singletonCImpl.stringProvider(), singletonCImpl.colorProvider(), singletonCImpl.dimensionConverter());
    }
    ...
    private RoomMemberListController roomMemberListController() {
      return new RoomMemberListController(singletonCImpl.avatarRendererProvider.get(), singletonCImpl.stringProvider(), singletonCImpl.colorProvider(), new RoomMemberSummaryFilter(), singletonCImpl.roleFormatter());
    }
    ...
    private RoomPollDetailNavigator roomPollDetailNavigator() {
      return new RoomPollDetailNavigator(singletonCImpl.defaultNavigatorProvider.get());
    }

    private RoomPollDetailController roomPollDetailController() {
      return new RoomPollDetailController(singletonCImpl.vectorDateFormatter());
    }
    ...
    private DeviceVerificationInfoBottomSheetController deviceVerificationInfoBottomSheetController(
      ...
      return new DeviceVerificationInfoBottomSheetController(singletonCImpl.stringProvider(), singletonCImpl.colorProvider(), singletonCImpl.vectorPreferences());
    }
    ...
    @Override
    public void injectBootstrapErrorFragment(BootstrapErrorFragment arg0) {
    }
    ...
    @Override
    public void injectSelfVerificationFragment(SelfVerificationFragment arg0) {
      injectSelfVerificationFragment2(arg0);
    }

    @Override
    public void injectUserVerificationBottomSheet(UserVerificationBottomSheet arg0) {
      injectUserVerificationBottomSheet2(arg0);
    }

    @Override
    public void injectUserVerificationFragment(UserVerificationFragment arg0) {
      injectUserVerificationFragment2(arg0);
    }
    ...
    @Override
    public void injectRoomPollDetailFragment(RoomPollDetailFragment arg0) {
      injectRoomPollDetailFragment2(arg0);
    }
    ...
    @Override
    public void injectVectorSettingsNotificationFragment(VectorSettingsNotificationFragment arg0) {
      injectVectorSettingsNotificationFragment2(arg0);
    }
    ...
    public void injectSignOutBottomSheetDialogFragment(SignOutBottomSheetDialogFragment arg0) {
      injectSignOutBottomSheetDialogFragment2(arg0);
    }
    ...
    private AttachmentsPreviewFragment injectAttachmentsPreviewFragment2(
      ...
      AttachmentsPreviewFragment_MembersInjector.injectClock(instance, singletonCImpl.providesDefaultClockProvider.get());
      return instance;
    }
    ...
    @CanIgnoreReturnValue
    private SelfVerificationFragment injectSelfVerificationFragment2(
        SelfVerificationFragment instance) {
      SelfVerificationFragment_MembersInjector.injectController(instance, selfVerificationController());
      return instance;
    }

    @CanIgnoreReturnValue
    private UserVerificationBottomSheet injectUserVerificationBottomSheet2(
        UserVerificationBottomSheet instance) {
      UserVerificationBottomSheet_MembersInjector.injectAvatarRenderer(instance, singletonCImpl.avatarRendererProvider.get());
      return instance;
    }

    @CanIgnoreReturnValue
    private UserVerificationFragment injectUserVerificationFragment2(
        UserVerificationFragment instance) {
      UserVerificationFragment_MembersInjector.injectController(instance, userVerificationController());
      return instance;
    }
    ...
    private TimelineFragment injectTimelineFragment2(TimelineFragment instance) {
      ...
      TimelineFragment_MembersInjector.injectClock(instance, singletonCImpl.providesDefaultClockProvider.get());
    ...
    private VoiceRecorderFragment injectVoiceRecorderFragment2(VoiceRecorderFragment instance) {
      ...
      VoiceRecorderFragment_MembersInjector.injectClock(instance, singletonCImpl.providesDefaultClockProvider.get());
      return instance;
    }
    ...
    private LiveLocationMapViewFragment injectLiveLocationMapViewFragment2(
      ...
      LiveLocationMapViewFragment_MembersInjector.injectDrawableProvider(instance, singletonCImpl.drawableProvider());
      return instance;
    }
    ...
    @CanIgnoreReturnValue
    private FtueAuthCombinedRegisterFragment injectFtueAuthCombinedRegisterFragment2(
        FtueAuthCombinedRegisterFragment instance) {
      FtueAuthCombinedRegisterFragment_MembersInjector.injectBuildMeta(instance, singletonCImpl.providesBuildMetaProvider.get());
      return instance;
    }

    @CanIgnoreReturnValue
    private FtueAuthCombinedServerSelectionFragment injectFtueAuthCombinedServerSelectionFragment2(
        FtueAuthCombinedServerSelectionFragment instance) {
      FtueAuthCombinedServerSelectionFragment_MembersInjector.injectBuildMeta(instance, singletonCImpl.providesBuildMetaProvider.get());
      return instance;
    }
    ...
    private RoomActivePollsFragment injectRoomActivePollsFragment2(
      ...
      RoomPollsListFragment_MembersInjector.injectViewNavigator(instance, new RoomPollsListNavigator());
      return instance;
    }

    @CanIgnoreReturnValue
    private RoomPollDetailFragment injectRoomPollDetailFragment2(RoomPollDetailFragment instance) {
      RoomPollDetailFragment_MembersInjector.injectViewNavigator(instance, roomPollDetailNavigator());
      RoomPollDetailFragment_MembersInjector.injectRoomPollDetailController(instance, roomPollDetailController());
      return instance;
    }
    ...
    private RoomUploadsFragment injectRoomUploadsFragment2(RoomUploadsFragment instance) {
      ...
      RoomUploadsFragment_MembersInjector.injectClock(instance, singletonCImpl.providesDefaultClockProvider.get());
      return instance;
    }
    ...
    private VectorSettingsSecurityPrivacyFragment injectVectorSettingsSecurityPrivacyFragment2(
      ...
      VectorSettingsSecurityPrivacyFragment_MembersInjector.injectBuildMeta(instance, singletonCImpl.providesBuildMetaProvider.get());
      return instance;
    }
    ...
    private KeyRequestsFragment injectKeyRequestsFragment2(KeyRequestsFragment instance) {
      KeyRequestsFragment_MembersInjector.injectClock(instance, singletonCImpl.providesDefaultClockProvider.get());
      return instance;
    }
    ...
    @CanIgnoreReturnValue
    private VectorSettingsNotificationFragment injectVectorSettingsNotificationFragment2(
        VectorSettingsNotificationFragment instance) {
      VectorSettingsNotificationFragment_MembersInjector.injectUnifiedPushHelper(instance, singletonCImpl.unifiedPushHelper());
      VectorSettingsNotificationFragment_MembersInjector.injectPushersManager(instance, singletonCImpl.pushersManager());
      VectorSettingsNotificationFragment_MembersInjector.injectFcmHelper(instance, singletonCImpl.googleFcmHelper());
      VectorSettingsNotificationFragment_MembersInjector.injectActiveSessionHolder(instance, singletonCImpl.activeSessionHolderProvider.get());
      VectorSettingsNotificationFragment_MembersInjector.injectVectorPreferences(instance, singletonCImpl.vectorPreferences());
      VectorSettingsNotificationFragment_MembersInjector.injectGuardServiceStarter(instance, FlavorModule_Companion_ProvideGuardServiceStarterFactory.provideGuardServiceStarter());
      VectorSettingsNotificationFragment_MembersInjector.injectVectorFeatures(instance, singletonCImpl.debugVectorFeatures());
      VectorSettingsNotificationFragment_MembersInjector.injectNotificationPermissionManager(instance, activityCImpl.notificationPermissionManager());
      VectorSettingsNotificationFragment_MembersInjector.injectEnsureFcmTokenIsRetrievedUseCase(instance, ensureFcmTokenIsRetrievedUseCase());
      return instance;
    }
    ...
    @CanIgnoreReturnValue
    private SignOutBottomSheetDialogFragment injectSignOutBottomSheetDialogFragment2(
        SignOutBottomSheetDialogFragment instance) {
      SignOutBottomSheetDialogFragment_MembersInjector.injectBuildMeta(instance, singletonCImpl.providesBuildMetaProvider.get());
      return instance;
    }
        ...
        switch (id) {
          ...
          return (T) new AutoCompleter.Factory() {
            ...
            public AutoCompleter create(String roomId3, boolean isInThreadTimeline) {
              return new AutoCompleter(roomId3, isInThreadTimeline, singletonCImpl.session(), singletonCImpl.avatarRendererProvider.get(), new CommandAutocompletePolicy(), fragmentCImpl.factoryProvider3.get(), fragmentCImpl.factoryProvider4.get(), fragmentCImpl.autocompleteRoomPresenter(), fragmentCImpl.autocompleteEmojiPresenter());
            }
          };
  ...
  private static final class ViewCImpl extends VectorApplication_HiltComponents.ViewC {
    ...
    private VoiceMessageRecorderView injectVoiceMessageRecorderView2(
      ...
      VoiceMessageRecorderView_MembersInjector.injectClock(instance, singletonCImpl.providesDefaultClockProvider.get());
  ...
  private static final class ActivityCImpl extends VectorApplication_HiltComponents.ActivityC {
    ...
    private OnboardingVariantFactory onboardingVariantFactory() {
      return new OnboardingVariantFactory(singletonCImpl.debugVectorFeatures(), screenOrientationLocker(), singletonCImpl.providesBuildMetaProvider.get());
    }
    ...
    @Override
    public void injectRoomPollDetailActivity(RoomPollDetailActivity arg0) {
      injectRoomPollDetailActivity2(arg0);
    }
    ...
    private MainActivity injectMainActivity2(MainActivity instance) {
      ...
      VectorBaseActivity_MembersInjector.injectMdmService(instance, singletonCImpl.defaultMdmServiceProvider.get());
    ...
    private DebugMenuActivity injectDebugMenuActivity2(DebugMenuActivity instance) {
      ...
      VectorBaseActivity_MembersInjector.injectMdmService(instance, singletonCImpl.defaultMdmServiceProvider.get());
      VectorBaseActivity_MembersInjector.injectDebugReceiver(instance, singletonCImpl.vectorDebugReceiver());
      DebugMenuActivity_MembersInjector.injectClock(instance, singletonCImpl.providesDefaultClockProvider.get());
      return instance;
    }
    ...
    @CanIgnoreReturnValue
    private RoomPollDetailActivity injectRoomPollDetailActivity2(RoomPollDetailActivity instance) {
      VectorBaseActivity_MembersInjector.injectAnalyticsTracker(instance, singletonCImpl.defaultVectorAnalyticsProvider.get());
      VectorBaseActivity_MembersInjector.injectSessionListener(instance, singletonCImpl.sessionListenerProvider.get());
      VectorBaseActivity_MembersInjector.injectBugReporter(instance, singletonCImpl.bugReporterProvider.get());
      VectorBaseActivity_MembersInjector.injectPinLocker(instance, singletonCImpl.pinLockerProvider.get());
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          return (T) new KeysBackupSetupSharedViewModel(singletonCImpl.providesDefaultClockProvider.get());
  ...
  private static final class ServiceCImpl extends VectorApplication_HiltComponents.ServiceC {
    ...
    @Override
    public void injectMicrophoneAccessService(MicrophoneAccessService arg0) {
      injectMicrophoneAccessService2(arg0);
    }
    ...
    private VectorSyncAndroidService injectVectorSyncAndroidService2(
      ...
      VectorSyncAndroidService_MembersInjector.injectClock(instance, singletonCImpl.providesDefaultClockProvider.get());
      return instance;
    }

    @CanIgnoreReturnValue
    private MicrophoneAccessService injectMicrophoneAccessService2(
        MicrophoneAccessService instance) {
      MicrophoneAccessService_MembersInjector.injectNotificationUtils(instance, singletonCImpl.notificationUtilsProvider.get());
      MicrophoneAccessService_MembersInjector.injectClock(instance, singletonCImpl.providesDefaultClockProvider.get());
      return instance;
    }
    ...
    private ScreenCaptureAndroidService injectScreenCaptureAndroidService2(
      ...
      ScreenCaptureAndroidService_MembersInjector.injectClock(instance, singletonCImpl.providesDefaultClockProvider.get());
      return instance;
    }
    ...
    private LocationSharingAndroidService injectLocationSharingAndroidService2(
      ...
      LocationSharingAndroidService_MembersInjector.injectPermissionChecker(instance, singletonCImpl.androidPermissionChecker());
      return instance;
    }
    ...
    private VectorFirebaseMessagingService injectVectorFirebaseMessagingService2(
      ...
      VectorFirebaseMessagingService_MembersInjector.injectMdmService(instance, singletonCImpl.defaultMdmServiceProvider.get());
      return instance;
    }
  }
  ...
  private static final class MavericksViewModelCImpl extends VectorApplication_HiltComponents.MavericksViewModelC {
    ...
    private Provider<InviteUsersToRoomViewModel.Factory> factoryProvider78;

    private Provider<ViewEditHistoryViewModel.Factory> factoryProvider79;

    private Provider<PillsPostProcessor.Factory> factoryProvider80;

    private Provider<MessageActionsViewModel.Factory> factoryProvider81;

    private Provider<SearchViewModel.Factory> factoryProvider82;

    private Provider<UnreadMessagesSharedViewModel.Factory> factoryProvider83;

    private Provider<UnknownDeviceDetectorSharedViewModel.Factory> factoryProvider84;

    private Provider<DiscoverySettingsViewModel.Factory> factoryProvider85;

    private Provider<LegalsViewModel.Factory> factoryProvider86;

    private Provider<TimelineViewModel.Factory> factoryProvider87;

    private Provider<MessageComposerViewModel.Factory> factoryProvider88;

    private Provider<SetIdentityServerViewModel.Factory> factoryProvider89;

    private Provider<BreadcrumbsViewModel.Factory> factoryProvider90;

    private Provider<HomeDetailViewModel.Factory> factoryProvider91;

    private Provider<DeviceVerificationInfoBottomSheetViewModel.Factory> factoryProvider92;

    private Provider<DeviceListBottomSheetViewModel.Factory> factoryProvider93;

    private Provider<HomeActivityViewModel.Factory> factoryProvider94;

    private Provider<BootstrapSharedViewModel.Factory> factoryProvider95;

    private Provider<UserVerificationViewModel.Factory> factoryProvider96;

    private Provider<SelfVerificationViewModel.Factory> factoryProvider97;

    private Provider<CreatePollViewModel.Factory> factoryProvider98;

    private Provider<LocationSharingViewModel.Factory> factoryProvider99;

    private Provider<LocationPreviewViewModel.Factory> factoryProvider100;

    private Provider<VectorAttachmentViewerViewModel.Factory> factoryProvider101;

    private Provider<LiveLocationMapViewModel.Factory> factoryProvider102;

    private Provider<FontScaleSettingViewModel.Factory> factoryProvider103;

    private Provider<HomeRoomListViewModel.Factory> factoryProvider104;

    private Provider<InvitesViewModel.Factory> factoryProvider105;

    private Provider<ReleaseNotesViewModel.Factory> factoryProvider106;

    private Provider<SessionOverviewViewModel.Factory> factoryProvider107;

    private Provider<OtherSessionsViewModel.Factory> factoryProvider108;

    private Provider<SessionDetailsViewModel.Factory> factoryProvider109;

    private Provider<RenameSessionViewModel.Factory> factoryProvider110;

    private Provider<SessionLearnMoreViewModel.Factory> factoryProvider111;

    private Provider<VectorSettingsLabsViewModel.Factory> factoryProvider112;

    private Provider<AttachmentTypeSelectorViewModel.Factory> factoryProvider113;

    private Provider<VectorSettingsNotificationViewModel.Factory> factoryProvider114;

    private Provider<VectorSettingsPushRuleNotificationViewModel.Factory> factoryProvider115;

    private Provider<SetLinkViewModel.Factory> factoryProvider116;

    private Provider<RoomPollsViewModel.Factory> factoryProvider117;

    private Provider<RoomPollDetailViewModel.Factory> factoryProvider118;

    private Provider<NewHomeDetailViewModel.Factory> factoryProvider119;
    ...
    private GetNotificationCountForSpacesUseCase getNotificationCountForSpacesUseCase() {
      return new GetNotificationCountForSpacesUseCase(singletonCImpl.activeSessionHolderProvider.get(), new CompileTimeAutoAcceptInvites());
    }

    private GetSpacesUseCase getSpacesUseCase() {
      return new GetSpacesUseCase(singletonCImpl.activeSessionHolderProvider.get());
    }

    private CallProximityManager callProximityManager() {
      return new CallProximityManager(singletonCImpl.context(), singletonCImpl.providesBuildMetaProvider.get());
    }
    ...
    private JitsiService jitsiService() {
      return new JitsiService(singletonCImpl.session(), singletonCImpl.rawService(), singletonCImpl.stringProvider(), singletonCImpl.themeProvider(), new JitsiJWTFactory(), singletonCImpl.providesDefaultClockProvider.get(), singletonCImpl.vectorLocaleProvider());
    }
    ...
    private CheckIfSessionIsInactiveUseCase checkIfSessionIsInactiveUseCase() {
      return new CheckIfSessionIsInactiveUseCase(singletonCImpl.providesDefaultClockProvider.get());
    }
    ...
    private ShouldShowUnverifiedSessionsAlertUseCase shouldShowUnverifiedSessionsAlertUseCase() {
      return new ShouldShowUnverifiedSessionsAlertUseCase(singletonCImpl.debugVectorFeatures(), singletonCImpl.vectorPreferences(), singletonCImpl.providesDefaultClockProvider.get());
    }

    private SetUnverifiedSessionsAlertShownUseCase setUnverifiedSessionsAlertShownUseCase() {
      return new SetUnverifiedSessionsAlertShownUseCase(singletonCImpl.vectorPreferences(), singletonCImpl.providesDefaultClockProvider.get());
    }
    ...
    private ChatEffectManager chatEffectManager() {
      return new ChatEffectManager(singletonCImpl.providesDefaultClockProvider.get());
    }
    ...
    private StartVoiceBroadcastUseCase startVoiceBroadcastUseCase() {
      return new StartVoiceBroadcastUseCase(singletonCImpl.session(), singletonCImpl.providesVoiceBroadcastRecorderProvider.get(), singletonCImpl.audioMessagePlaybackTrackerProvider.get(), singletonCImpl.context(), singletonCImpl.providesBuildMetaProvider.get(), getRoomLiveVoiceBroadcastsUseCase(), stopVoiceBroadcastUseCase(), pauseVoiceBroadcastUseCase());
    }
    ...
    private VoteToPollUseCase voteToPollUseCase() {
      return new VoteToPollUseCase(singletonCImpl.activeSessionHolderProvider.get());
    }
    ...
    private VoiceRecorderProvider voiceRecorderProvider() {
      return new VoiceRecorderProvider(singletonCImpl.context(), singletonCImpl.debugVectorFeatures(), LockScreenModule_ProvideBuildVersionSdkIntProviderFactory.provideBuildVersionSdkIntProvider(), singletonCImpl.androidPermissionChecker());
    }
    ...
    private DownloadMediaUseCase downloadMediaUseCase() {
      return new DownloadMediaUseCase(ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule), singletonCImpl.session(), singletonCImpl.notificationUtilsProvider.get(), singletonCImpl.providesDefaultClockProvider.get());
    }
    ...
    private GetTimelineEventUseCase getTimelineEventUseCase() {
      return new GetTimelineEventUseCase(singletonCImpl.activeSessionHolderProvider.get());
    }
    ...
    private GetEndedPollEventIdUseCase getEndedPollEventIdUseCase() {
      return new GetEndedPollEventIdUseCase(singletonCImpl.activeSessionHolderProvider.get());
    }

    private RoomPollDetailMapper roomPollDetailMapper() {
      return new RoomPollDetailMapper(pollResponseDataFactory(), pollItemViewStateFactory(), getEndedPollEventIdUseCase());
    }

    private GetSpacesNotificationBadgeStateUseCase getSpacesNotificationBadgeStateUseCase() {
    ...
    private void initialize() {
      ...
      this.factoryProvider78 = SingleCheck.provider(new SwitchingProvider<InviteUsersToRoomViewModel.Factory>(singletonCImpl, mavericksViewModelCImpl, 78));
      this.factoryProvider79 = SingleCheck.provider(new SwitchingProvider<ViewEditHistoryViewModel.Factory>(singletonCImpl, mavericksViewModelCImpl, 79));
      this.factoryProvider80 = SingleCheck.provider(new SwitchingProvider<PillsPostProcessor.Factory>(singletonCImpl, mavericksViewModelCImpl, 81));
      this.factoryProvider81 = SingleCheck.provider(new SwitchingProvider<MessageActionsViewModel.Factory>(singletonCImpl, mavericksViewModelCImpl, 80));
      this.factoryProvider82 = SingleCheck.provider(new SwitchingProvider<SearchViewModel.Factory>(singletonCImpl, mavericksViewModelCImpl, 82));
      this.factoryProvider83 = SingleCheck.provider(new SwitchingProvider<UnreadMessagesSharedViewModel.Factory>(singletonCImpl, mavericksViewModelCImpl, 83));
      this.factoryProvider84 = SingleCheck.provider(new SwitchingProvider<UnknownDeviceDetectorSharedViewModel.Factory>(singletonCImpl, mavericksViewModelCImpl, 84));
      this.factoryProvider85 = SingleCheck.provider(new SwitchingProvider<DiscoverySettingsViewModel.Factory>(singletonCImpl, mavericksViewModelCImpl, 85));
      this.factoryProvider86 = SingleCheck.provider(new SwitchingProvider<LegalsViewModel.Factory>(singletonCImpl, mavericksViewModelCImpl, 86));
      this.factoryProvider87 = SingleCheck.provider(new SwitchingProvider<TimelineViewModel.Factory>(singletonCImpl, mavericksViewModelCImpl, 87));
      this.factoryProvider88 = SingleCheck.provider(new SwitchingProvider<MessageComposerViewModel.Factory>(singletonCImpl, mavericksViewModelCImpl, 88));
      this.factoryProvider89 = SingleCheck.provider(new SwitchingProvider<SetIdentityServerViewModel.Factory>(singletonCImpl, mavericksViewModelCImpl, 89));
      this.factoryProvider90 = SingleCheck.provider(new SwitchingProvider<BreadcrumbsViewModel.Factory>(singletonCImpl, mavericksViewModelCImpl, 90));
      this.factoryProvider91 = SingleCheck.provider(new SwitchingProvider<HomeDetailViewModel.Factory>(singletonCImpl, mavericksViewModelCImpl, 91));
      this.factoryProvider92 = SingleCheck.provider(new SwitchingProvider<DeviceVerificationInfoBottomSheetViewModel.Factory>(singletonCImpl, mavericksViewModelCImpl, 92));
      this.factoryProvider93 = SingleCheck.provider(new SwitchingProvider<DeviceListBottomSheetViewModel.Factory>(singletonCImpl, mavericksViewModelCImpl, 93));
      this.factoryProvider94 = SingleCheck.provider(new SwitchingProvider<HomeActivityViewModel.Factory>(singletonCImpl, mavericksViewModelCImpl, 94));
      this.factoryProvider95 = SingleCheck.provider(new SwitchingProvider<BootstrapSharedViewModel.Factory>(singletonCImpl, mavericksViewModelCImpl, 95));
      this.factoryProvider96 = SingleCheck.provider(new SwitchingProvider<UserVerificationViewModel.Factory>(singletonCImpl, mavericksViewModelCImpl, 96));
      this.factoryProvider97 = SingleCheck.provider(new SwitchingProvider<SelfVerificationViewModel.Factory>(singletonCImpl, mavericksViewModelCImpl, 97));
      this.factoryProvider98 = SingleCheck.provider(new SwitchingProvider<CreatePollViewModel.Factory>(singletonCImpl, mavericksViewModelCImpl, 98));
      this.factoryProvider99 = SingleCheck.provider(new SwitchingProvider<LocationSharingViewModel.Factory>(singletonCImpl, mavericksViewModelCImpl, 99));
    }

    @SuppressWarnings("unchecked")
    private void initialize2() {
      this.factoryProvider100 = SingleCheck.provider(new SwitchingProvider<LocationPreviewViewModel.Factory>(singletonCImpl, mavericksViewModelCImpl, 100));
      this.factoryProvider101 = SingleCheck.provider(new SwitchingProvider<VectorAttachmentViewerViewModel.Factory>(singletonCImpl, mavericksViewModelCImpl, 101));
      this.factoryProvider102 = SingleCheck.provider(new SwitchingProvider<LiveLocationMapViewModel.Factory>(singletonCImpl, mavericksViewModelCImpl, 102));
      this.factoryProvider103 = SingleCheck.provider(new SwitchingProvider<FontScaleSettingViewModel.Factory>(singletonCImpl, mavericksViewModelCImpl, 103));
      this.factoryProvider104 = SingleCheck.provider(new SwitchingProvider<HomeRoomListViewModel.Factory>(singletonCImpl, mavericksViewModelCImpl, 104));
      this.factoryProvider105 = SingleCheck.provider(new SwitchingProvider<InvitesViewModel.Factory>(singletonCImpl, mavericksViewModelCImpl, 105));
      this.factoryProvider106 = SingleCheck.provider(new SwitchingProvider<ReleaseNotesViewModel.Factory>(singletonCImpl, mavericksViewModelCImpl, 106));
      this.factoryProvider107 = SingleCheck.provider(new SwitchingProvider<SessionOverviewViewModel.Factory>(singletonCImpl, mavericksViewModelCImpl, 107));
      this.factoryProvider108 = SingleCheck.provider(new SwitchingProvider<OtherSessionsViewModel.Factory>(singletonCImpl, mavericksViewModelCImpl, 108));
      this.factoryProvider109 = SingleCheck.provider(new SwitchingProvider<SessionDetailsViewModel.Factory>(singletonCImpl, mavericksViewModelCImpl, 109));
      this.factoryProvider110 = SingleCheck.provider(new SwitchingProvider<RenameSessionViewModel.Factory>(singletonCImpl, mavericksViewModelCImpl, 110));
      this.factoryProvider111 = SingleCheck.provider(new SwitchingProvider<SessionLearnMoreViewModel.Factory>(singletonCImpl, mavericksViewModelCImpl, 111));
      this.factoryProvider112 = SingleCheck.provider(new SwitchingProvider<VectorSettingsLabsViewModel.Factory>(singletonCImpl, mavericksViewModelCImpl, 112));
      this.factoryProvider113 = SingleCheck.provider(new SwitchingProvider<AttachmentTypeSelectorViewModel.Factory>(singletonCImpl, mavericksViewModelCImpl, 113));
      this.factoryProvider114 = SingleCheck.provider(new SwitchingProvider<VectorSettingsNotificationViewModel.Factory>(singletonCImpl, mavericksViewModelCImpl, 114));
      this.factoryProvider115 = SingleCheck.provider(new SwitchingProvider<VectorSettingsPushRuleNotificationViewModel.Factory>(singletonCImpl, mavericksViewModelCImpl, 115));
      this.factoryProvider116 = SingleCheck.provider(new SwitchingProvider<SetLinkViewModel.Factory>(singletonCImpl, mavericksViewModelCImpl, 116));
      this.factoryProvider117 = SingleCheck.provider(new SwitchingProvider<RoomPollsViewModel.Factory>(singletonCImpl, mavericksViewModelCImpl, 117));
      this.factoryProvider118 = SingleCheck.provider(new SwitchingProvider<RoomPollDetailViewModel.Factory>(singletonCImpl, mavericksViewModelCImpl, 118));
      this.factoryProvider119 = SingleCheck.provider(new SwitchingProvider<NewHomeDetailViewModel.Factory>(singletonCImpl, mavericksViewModelCImpl, 119));
    }

    @Override
    public Map<Class<? extends MavericksViewModel<?>>, MavericksAssistedViewModelFactory<?, ?>> getViewModelFactories(
        ) {
      return ImmutableMap.<Class<? extends MavericksViewModel<?>>, MavericksAssistedViewModelFactory<?, ?>>builderWithExpectedSize(117).put(LockScreenViewModel.class, factoryProvider.get()).put(DebugAnalyticsViewModel.class, factoryProvider2.get()).put(DebugPrivateSettingsViewModel.class, factoryProvider3.get()).put(DebugMemoryLeaksViewModel.class, factoryProvider4.get()).put(RoomListViewModel.class, factoryProvider5.get()).put(SpaceManageRoomsViewModel.class, factoryProvider6.get()).put(SpaceManageSharedViewModel.class, factoryProvider7.get()).put(SpaceListViewModel.class, factoryProvider8.get()).put(ReAuthViewModel.class, factoryProvider9.get()).put(VectorCallViewModel.class, factoryProvider10.get()).put(JitsiCallViewModel.class, factoryProvider11.get()).put(RoomDirectoryViewModel.class, factoryProvider12.get()).put(ViewReactionsViewModel.class, factoryProvider13.get()).put(RoomWidgetPermissionViewModel.class, factoryProvider14.get()).put(WidgetViewModel.class, factoryProvider16.get()).put(ServerBackupStatusViewModel.class, factoryProvider17.get()).put(SignoutCheckViewModel.class, factoryProvider18.get()).put(RoomDirectoryPickerViewModel.class, factoryProvider19.get()).put(RoomDevToolViewModel.class, factoryProvider20.get()).put(MigrateRoomViewModel.class, factoryProvider21.get()).put(IgnoredUsersViewModel.class, factoryProvider22.get()).put(CallTransferViewModel.class, factoryProvider23.get()).put(ContactsBookViewModel.class, factoryProvider24.get()).put(CreateDirectRoomViewModel.class, factoryProvider25.get()).put(QrCodeScannerViewModel.class, factoryProvider26.get()).put(RoomNotificationSettingsViewModel.class, factoryProvider27.get()).put(KeysBackupSettingsViewModel.class, factoryProvider28.get()).put(SharedSecureStorageViewModel.class, factoryProvider29.get()).put(UserListViewModel.class, factoryProvider30.get()).put(UserCodeSharedViewModel.class, factoryProvider31.get()).put(ReviewTermsViewModel.class, factoryProvider32.get()).put(ShareSpaceViewModel.class, factoryProvider33.get()).put(SpacePreviewViewModel.class, factoryProvider34.get()).put(SpacePeopleViewModel.class, factoryProvider35.get()).put(SpaceAddRoomsViewModel.class, factoryProvider36.get()).put(SpaceLeaveAdvancedViewModel.class, factoryProvider37.get()).put(SpaceInviteBottomSheetViewModel.class, factoryProvider38.get()).put(SpaceDirectoryViewModel.class, factoryProvider39.get()).put(CreateSpaceViewModel.class, factoryProvider40.get()).put(SpaceMenuViewModel.class, factoryProvider41.get()).put(SoftLogoutViewModel.class, factoryProvider42.get()).put(IncomingShareViewModel.class, factoryProvider43.get()).put(ThreePidsSettingsViewModel.class, factoryProvider44.get()).put(PushGatewaysViewModel.class, factoryProvider45.get()).put(HomeserverSettingsViewModel.class, factoryProvider46.get()).put(LocalePickerViewModel.class, factoryProvider47.get()).put(GossipingEventsPaperTrailViewModel.class, factoryProvider48.get()).put(AccountDataViewModel.class, factoryProvider49.get()).put(DevicesViewModel.class, factoryProvider50.get()).put(im.vector.app.features.settings.devices.v2.DevicesViewModel.class, factoryProvider51.get()).put(KeyRequestListViewModel.class, factoryProvider52.get()).put(KeyRequestViewModel.class, factoryProvider53.get()).put(CrossSigningSettingsViewModel.class, factoryProvider54.get()).put(DeactivateAccountViewModel.class, factoryProvider55.get()).put(RoomUploadsViewModel.class, factoryProvider56.get()).put(RoomJoinRuleChooseRestrictedViewModel.class, factoryProvider57.get()).put(RoomSettingsViewModel.class, factoryProvider58.get()).put(RoomPermissionsViewModel.class, factoryProvider59.get()).put(RoomMemberListViewModel.class, factoryProvider60.get()).put(RoomBannedMemberListViewModel.class, factoryProvider61.get()).put(RoomAliasViewModel.class, factoryProvider62.get()).put(RoomAliasBottomSheetViewModel.class, factoryProvider63.get()).put(RoomProfileViewModel.class, factoryProvider64.get()).put(RoomMemberProfileViewModel.class, factoryProvider65.get()).put(UserColorAccountDataViewModel.class, factoryProvider66.get()).put(RoomPreviewViewModel.class, factoryProvider67.get()).put(CreateRoomViewModel.class, factoryProvider68.get()).put(RequireActiveMembershipViewModel.class, factoryProvider69.get()).put(EmojiSearchResultViewModel.class, factoryProvider70.get()).put(BugReportViewModel.class, factoryProvider71.get()).put(MatrixToBottomSheetViewModel.class, factoryProvider72.get()).put(OnboardingViewModel.class, factoryProvider73.get()).put(LoginViewModel.class, factoryProvider74.get()).put(AnalyticsConsentViewModel.class, factoryProvider75.get()).put(AnalyticsAccountDataViewModel.class, factoryProvider76.get()).put(StartAppViewModel.class, factoryProvider77.get()).put(InviteUsersToRoomViewModel.class, factoryProvider78.get()).put(ViewEditHistoryViewModel.class, factoryProvider79.get()).put(MessageActionsViewModel.class, factoryProvider81.get()).put(SearchViewModel.class, factoryProvider82.get()).put(UnreadMessagesSharedViewModel.class, factoryProvider83.get()).put(UnknownDeviceDetectorSharedViewModel.class, factoryProvider84.get()).put(DiscoverySettingsViewModel.class, factoryProvider85.get()).put(LegalsViewModel.class, factoryProvider86.get()).put(TimelineViewModel.class, factoryProvider87.get()).put(MessageComposerViewModel.class, factoryProvider88.get()).put(SetIdentityServerViewModel.class, factoryProvider89.get()).put(BreadcrumbsViewModel.class, factoryProvider90.get()).put(HomeDetailViewModel.class, factoryProvider91.get()).put(DeviceVerificationInfoBottomSheetViewModel.class, factoryProvider92.get()).put(DeviceListBottomSheetViewModel.class, factoryProvider93.get()).put(HomeActivityViewModel.class, factoryProvider94.get()).put(BootstrapSharedViewModel.class, factoryProvider95.get()).put(UserVerificationViewModel.class, factoryProvider96.get()).put(SelfVerificationViewModel.class, factoryProvider97.get()).put(CreatePollViewModel.class, factoryProvider98.get()).put(LocationSharingViewModel.class, factoryProvider99.get()).put(LocationPreviewViewModel.class, factoryProvider100.get()).put(VectorAttachmentViewerViewModel.class, factoryProvider101.get()).put(LiveLocationMapViewModel.class, factoryProvider102.get()).put(FontScaleSettingViewModel.class, factoryProvider103.get()).put(HomeRoomListViewModel.class, factoryProvider104.get()).put(InvitesViewModel.class, factoryProvider105.get()).put(ReleaseNotesViewModel.class, factoryProvider106.get()).put(SessionOverviewViewModel.class, factoryProvider107.get()).put(OtherSessionsViewModel.class, factoryProvider108.get()).put(SessionDetailsViewModel.class, factoryProvider109.get()).put(RenameSessionViewModel.class, factoryProvider110.get()).put(SessionLearnMoreViewModel.class, factoryProvider111.get()).put(VectorSettingsLabsViewModel.class, factoryProvider112.get()).put(AttachmentTypeSelectorViewModel.class, factoryProvider113.get()).put(VectorSettingsNotificationViewModel.class, factoryProvider114.get()).put(VectorSettingsPushRuleNotificationViewModel.class, factoryProvider115.get()).put(SetLinkViewModel.class, factoryProvider116.get()).put(RoomPollsViewModel.class, factoryProvider117.get()).put(RoomPollDetailViewModel.class, factoryProvider118.get()).put(NewHomeDetailViewModel.class, factoryProvider119.get()).build();
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
        ...
        switch (id) {
          ...
          return (T) new SpaceListViewModel.Factory() {
            ...
            public SpaceListViewModel create(SpaceListViewState initialState8) {
              return new SpaceListViewModel(initialState8, singletonCImpl.spaceStateHandlerImplProvider.get(), singletonCImpl.session(), singletonCImpl.vectorPreferences(), singletonCImpl.defaultVectorAnalyticsProvider.get(), mavericksViewModelCImpl.getNotificationCountForSpacesUseCase(), mavericksViewModelCImpl.getSpacesUseCase());
            }
          };
          ...
          return (T) new UserListViewModel.Factory() {
            ...
            public UserListViewModel create(UserListViewState initialState29) {
              return new UserListViewModel(initialState29, singletonCImpl.stringProvider(), singletonCImpl.rawService(), singletonCImpl.session());
            }
          };
          ...
          return (T) new DevicesViewModel.Factory() {
            ...
            public DevicesViewModel create(DevicesViewState initialState49) {
              return new DevicesViewModel(initialState49, singletonCImpl.session(), singletonCImpl.reAuthHelperProvider.get(), singletonCImpl.stringProvider(), mavericksViewModelCImpl.pendingAuthHandler(), mavericksViewModelCImpl.checkIfSessionIsInactiveUseCase(), mavericksViewModelCImpl.getCurrentSessionCrossSigningInfoUseCase(), mavericksViewModelCImpl.getEncryptionTrustLevelForDeviceUseCase(), singletonCImpl.supportedVerificationMethodsProvider());
            }
          };
          ...
          return (T) new RoomMemberListViewModel.Factory() {
            ...
            public RoomMemberListViewModel create(RoomMemberListViewState initialState59) {
              return new RoomMemberListViewModel(initialState59, new RoomMemberListComparator(), singletonCImpl.session());
            }
          };
          ...
          return (T) new StartAppViewModel.Factory() {
            ...
            public StartAppViewModel create(StartAppViewState initialState76) {
              return new StartAppViewModel(initialState76, singletonCImpl.activeSessionHolderProvider.get(), VectorStaticModule_ProvidesCoroutineDispatchersFactory.providesCoroutineDispatchers());
            }
          };

          case 78: // im.vector.app.features.invite.InviteUsersToRoomViewModel.Factory 
          return (T) new InviteUsersToRoomViewModel.Factory() {
            @Override
            public InviteUsersToRoomViewModel create(InviteUsersToRoomViewState initialState77) {
              return new InviteUsersToRoomViewModel(initialState77, singletonCImpl.session(), singletonCImpl.stringProvider());
            }
          };

          case 79: // im.vector.app.features.home.room.detail.timeline.edithistory.ViewEditHistoryViewModel.Factory 
          return (T) new ViewEditHistoryViewModel.Factory() {
            @Override
            public ViewEditHistoryViewModel create(ViewEditHistoryViewState initialState78) {
              return new ViewEditHistoryViewModel(initialState78, singletonCImpl.session());
            }
          };

          case 80: // im.vector.app.features.home.room.detail.timeline.action.MessageActionsViewModel.Factory 
          return (T) new MessageActionsViewModel.Factory() {
            @Override
            public MessageActionsViewModel create(MessageActionState initialState79) {
              return new MessageActionsViewModel(initialState79, DoubleCheck.lazy(singletonCImpl.eventHtmlRendererProvider), singletonCImpl.vectorHtmlCompressorProvider.get(), singletonCImpl.session(), singletonCImpl.noticeEventFormatter(), singletonCImpl.defaultErrorFormatter(), singletonCImpl.stringProvider(), mavericksViewModelCImpl.factoryProvider80.get(), singletonCImpl.vectorPreferences(), new CheckIfCanReplyEventUseCase(), mavericksViewModelCImpl.checkIfCanRedactEventUseCase());
            }
          };

          case 81: // im.vector.app.features.html.PillsPostProcessor.Factory 
          return (T) new PillsPostProcessor.Factory() {
            @Override
            public PillsPostProcessor create(String roomId2) {
              return new PillsPostProcessor(roomId2, singletonCImpl.context(), singletonCImpl.avatarRendererProvider.get(), singletonCImpl.activeSessionHolderProvider.get());
          ...
          case 82: // im.vector.app.features.home.room.detail.search.SearchViewModel.Factory 
          return (T) new SearchViewModel.Factory() {
            @Override
            public SearchViewModel create(SearchViewState initialState80) {
              return new SearchViewModel(initialState80, singletonCImpl.session());
            }
          };

          case 83: // im.vector.app.features.home.UnreadMessagesSharedViewModel.Factory 
          return (T) new UnreadMessagesSharedViewModel.Factory() {
            @Override
            public UnreadMessagesSharedViewModel create(UnreadMessagesState initialState81) {
              return new UnreadMessagesSharedViewModel(initialState81, singletonCImpl.session(), singletonCImpl.vectorPreferences(), singletonCImpl.spaceStateHandlerImplProvider.get(), new CompileTimeAutoAcceptInvites());
            }
          };

          case 84: // im.vector.app.features.home.UnknownDeviceDetectorSharedViewModel.Factory 
          return (T) new UnknownDeviceDetectorSharedViewModel.Factory() {
            @Override
            public UnknownDeviceDetectorSharedViewModel create(UnknownDevicesState initialState82) {
              return new UnknownDeviceDetectorSharedViewModel(initialState82, singletonCImpl.session(), singletonCImpl.providesDefaultClockProvider.get(), mavericksViewModelCImpl.shouldShowUnverifiedSessionsAlertUseCase(), mavericksViewModelCImpl.setUnverifiedSessionsAlertShownUseCase(), mavericksViewModelCImpl.isNewLoginAlertShownUseCase(), mavericksViewModelCImpl.setNewLoginAlertShownUseCase(), mavericksViewModelCImpl.deleteUnusedClientInformationUseCase());
            }
          };

          case 85: // im.vector.app.features.discovery.DiscoverySettingsViewModel.Factory 
          return (T) new DiscoverySettingsViewModel.Factory() {
            @Override
            public DiscoverySettingsViewModel create(DiscoverySettingsState initialState83) {
              return new DiscoverySettingsViewModel(initialState83, singletonCImpl.session(), singletonCImpl.stringProvider());
            }
          };

          case 86: // im.vector.app.features.settings.legals.LegalsViewModel.Factory 
          return (T) new LegalsViewModel.Factory() {
            @Override
            public LegalsViewModel create(LegalsState initialState84) {
              return new LegalsViewModel(initialState84, singletonCImpl.session(), singletonCImpl.stringProvider());
            }
          };

          case 87: // im.vector.app.features.home.room.detail.TimelineViewModel.Factory 
          return (T) new TimelineViewModel.Factory() {
            @Override
            public TimelineViewModel create(RoomDetailViewState initialState85) {
              return new TimelineViewModel(initialState85, singletonCImpl.vectorPreferences(), singletonCImpl.vectorDataStore(), singletonCImpl.stringProvider(), singletonCImpl.session(), singletonCImpl.rawService(), singletonCImpl.supportedVerificationMethodsProvider(), mavericksViewModelCImpl.stickerPickerActionHandler(), mavericksViewModelCImpl.typingHelper(), singletonCImpl.webRtcCallManagerProvider.get(), mavericksViewModelCImpl.chatEffectManager(), mavericksViewModelCImpl.directRoomHelper(), mavericksViewModelCImpl.jitsiService(), singletonCImpl.defaultVectorAnalyticsProvider.get(), singletonCImpl.jitsiActiveConferenceHolderProvider.get(), singletonCImpl.decryptionFailureTrackerProvider.get(), singletonCImpl.notificationDrawerManagerProvider.get(), singletonCImpl.locationSharingServiceConnectionProvider.get(), mavericksViewModelCImpl.stopLiveLocationShareUseCase(), new RedactLiveLocationShareEventUseCase(), ConfigurationModule_ProvidesCryptoConfigFactory.providesCryptoConfig(), singletonCImpl.providesBuildMetaProvider.get(), mavericksViewModelCImpl.timelineFactory(), singletonCImpl.spaceStateHandlerImplProvider.get(), mavericksViewModelCImpl.voiceBroadcastHelper(), mavericksViewModelCImpl.voteToPollUseCase());
            }
          };

          case 88: // im.vector.app.features.home.room.detail.composer.MessageComposerViewModel.Factory 
          return (T) new MessageComposerViewModel.Factory() {
            @Override
            public MessageComposerViewModel create(MessageComposerViewState initialState86) {
              return new MessageComposerViewModel(initialState86, singletonCImpl.session(), singletonCImpl.stringProvider(), singletonCImpl.vectorPreferences(), mavericksViewModelCImpl.commandParser(), new RainbowGenerator(), mavericksViewModelCImpl.audioMessageHelper(), singletonCImpl.defaultVectorAnalyticsProvider.get(), mavericksViewModelCImpl.voiceBroadcastHelper(), singletonCImpl.providesDefaultClockProvider.get(), singletonCImpl.getVoiceBroadcastStateEventLiveUseCase());
            }
          };

          case 89: // im.vector.app.features.discovery.change.SetIdentityServerViewModel.Factory 
          return (T) new SetIdentityServerViewModel.Factory() {
            @Override
            public SetIdentityServerViewModel create(SetIdentityServerState initialState87) {
              return new SetIdentityServerViewModel(initialState87, singletonCImpl.session(), singletonCImpl.stringProvider());
            }
          };

          case 90: // im.vector.app.features.home.room.breadcrumbs.BreadcrumbsViewModel.Factory 
          return (T) new BreadcrumbsViewModel.Factory() {
            @Override
            public BreadcrumbsViewModel create(BreadcrumbsViewState initialState88) {
              return new BreadcrumbsViewModel(initialState88, singletonCImpl.session());
            }
          };

          case 91: // im.vector.app.features.home.HomeDetailViewModel.Factory 
          return (T) new HomeDetailViewModel.Factory() {
            @Override
            public HomeDetailViewModel create(HomeDetailViewState initialState89) {
              return new HomeDetailViewModel(initialState89, singletonCImpl.session(), singletonCImpl.sharedPreferencesUiStateRepository(), singletonCImpl.vectorDataStore(), singletonCImpl.webRtcCallManagerProvider.get(), mavericksViewModelCImpl.directRoomHelper(), singletonCImpl.spaceStateHandlerImplProvider.get(), new CompileTimeAutoAcceptInvites(), singletonCImpl.debugVectorOverrides());
            }
          };

          case 92: // im.vector.app.features.settings.devices.DeviceVerificationInfoBottomSheetViewModel.Factory 
          return (T) new DeviceVerificationInfoBottomSheetViewModel.Factory() {
            @Override
            public DeviceVerificationInfoBottomSheetViewModel create(
                DeviceVerificationInfoBottomSheetViewState initialState90) {
              return new DeviceVerificationInfoBottomSheetViewModel(initialState90, singletonCImpl.session());
            }
          };

          case 93: // im.vector.app.features.roommemberprofile.devices.DeviceListBottomSheetViewModel.Factory 
          return (T) new DeviceListBottomSheetViewModel.Factory() {
            @Override
            public DeviceListBottomSheetViewModel create(DeviceListViewState initialState91) {
              return new DeviceListBottomSheetViewModel(initialState91, singletonCImpl.session());
            }
          };

          case 94: // im.vector.app.features.home.HomeActivityViewModel.Factory 
          return (T) new HomeActivityViewModel.Factory() {
            @Override
            public HomeActivityViewModel create(HomeActivityViewState initialState92) {
              return new HomeActivityViewModel(initialState92, singletonCImpl.activeSessionHolderProvider.get(), singletonCImpl.rawService(), singletonCImpl.reAuthHelperProvider.get(), singletonCImpl.analyticsStore(), singletonCImpl.lightweightSettingsStorage(), singletonCImpl.vectorPreferences(), singletonCImpl.defaultVectorAnalyticsProvider.get(), ConfigurationModule_ProvidesAnalyticsConfigFactory.providesAnalyticsConfig(), mavericksViewModelCImpl.releaseNotesPreferencesStore(), mavericksViewModelCImpl.stopOngoingVoiceBroadcastUseCase(), singletonCImpl.pushersManager(), mavericksViewModelCImpl.registerUnifiedPushUseCase(), singletonCImpl.unregisterUnifiedPushUseCase(), mavericksViewModelCImpl.ensureFcmTokenIsRetrievedUseCase(), mavericksViewModelCImpl.ensureSessionSyncingUseCase(), VectorStaticModule_ProvidesCoroutineDispatchersFactory.providesCoroutineDispatchers());
            }
          };

          case 95: // im.vector.app.features.crypto.recover.BootstrapSharedViewModel.Factory 
          return (T) new BootstrapSharedViewModel.Factory() {
            @Override
            public BootstrapSharedViewModel create(BootstrapViewState initialState93) {
              return new BootstrapSharedViewModel(initialState93, singletonCImpl.stringProvider(), singletonCImpl.defaultErrorFormatter(), singletonCImpl.session(), singletonCImpl.rawService(), mavericksViewModelCImpl.bootstrapCrossSigningTask(), mavericksViewModelCImpl.backupToQuadSMigrationTask(), mavericksViewModelCImpl.pendingAuthHandler());
            }
          };

          case 96: // im.vector.app.features.crypto.verification.user.UserVerificationViewModel.Factory 
          return (T) new UserVerificationViewModel.Factory() {
            @Override
            public UserVerificationViewModel create(UserVerificationViewState initialState94) {
              return new UserVerificationViewModel(initialState94, singletonCImpl.session(), singletonCImpl.supportedVerificationMethodsProvider(), singletonCImpl.stringProvider(), singletonCImpl.providesMatrixProvider.get());
            }
          };

          case 97: // im.vector.app.features.crypto.verification.self.SelfVerificationViewModel.Factory 
          return (T) new SelfVerificationViewModel.Factory() {
            @Override
            public SelfVerificationViewModel create(SelfVerificationViewState initialState95) {
              return new SelfVerificationViewModel(initialState95, singletonCImpl.session(), singletonCImpl.supportedVerificationMethodsProvider(), singletonCImpl.rawService(), singletonCImpl.stringProvider(), singletonCImpl.providesMatrixProvider.get());
            }
          };

          case 98: // im.vector.app.features.poll.create.CreatePollViewModel.Factory 
          return (T) new CreatePollViewModel.Factory() {
            @Override
            public CreatePollViewModel create(CreatePollViewState initialState96) {
              return new CreatePollViewModel(initialState96, singletonCImpl.session());
            }
          };

          case 99: // im.vector.app.features.location.LocationSharingViewModel.Factory 
          return (T) new LocationSharingViewModel.Factory() {
            @Override
            public LocationSharingViewModel create(LocationSharingViewState initialState97) {
              return new LocationSharingViewModel(initialState97, singletonCImpl.locationTrackerProvider.get(), singletonCImpl.locationPinProvider.get(), singletonCImpl.session(), mavericksViewModelCImpl.compareLocationsUseCase(), singletonCImpl.vectorPreferences(), singletonCImpl.androidPermissionChecker());
            }
          };
      ...
      private T get1() {
        switch (id) {
          case 100: // im.vector.app.features.location.preview.LocationPreviewViewModel.Factory 
          return (T) new LocationPreviewViewModel.Factory() {
            @Override
            public LocationPreviewViewModel create(LocationPreviewViewState initialState98) {
              return new LocationPreviewViewModel(initialState98, singletonCImpl.session(), singletonCImpl.locationPinProvider.get(), singletonCImpl.locationTrackerProvider.get(), singletonCImpl.androidPermissionChecker());
            }
          };

          case 101: // im.vector.app.features.media.VectorAttachmentViewerViewModel.Factory 
          return (T) new VectorAttachmentViewerViewModel.Factory() {
            @Override
            public VectorAttachmentViewerViewModel create(VectorDummyViewState initialState99) {
              return new VectorAttachmentViewerViewModel(initialState99, singletonCImpl.session(), mavericksViewModelCImpl.downloadMediaUseCase());
            }
          };

          case 102: // im.vector.app.features.location.live.map.LiveLocationMapViewModel.Factory 
          return (T) new LiveLocationMapViewModel.Factory() {
            @Override
            public LiveLocationMapViewModel create(LiveLocationMapViewState initialState100) {
              return new LiveLocationMapViewModel(initialState100, singletonCImpl.session(), mavericksViewModelCImpl.getListOfUserLiveLocationUseCase(), singletonCImpl.locationSharingServiceConnectionProvider.get(), mavericksViewModelCImpl.stopLiveLocationShareUseCase(), singletonCImpl.locationTrackerProvider.get(), singletonCImpl.androidPermissionChecker());
            }
          };

          case 103: // im.vector.app.features.settings.font.FontScaleSettingViewModel.Factory 
          return (T) new FontScaleSettingViewModel.Factory() {
            @Override
            public FontScaleSettingViewModel create(FontScaleSettingViewState initialState101) {
              return new FontScaleSettingViewModel(initialState101, singletonCImpl.vectorConfiguration(), singletonCImpl.fontScalePreferencesImpl());
            }
          };

          case 104: // im.vector.app.features.home.room.list.home.HomeRoomListViewModel.Factory 
          return (T) new HomeRoomListViewModel.Factory() {
            @Override
            public HomeRoomListViewModel create(HomeRoomListViewState initialState102) {
              return new HomeRoomListViewModel(initialState102, singletonCImpl.session(), singletonCImpl.spaceStateHandlerImplProvider.get(), mavericksViewModelCImpl.homeLayoutPreferencesStore(), singletonCImpl.stringProvider(), singletonCImpl.drawableProvider(), singletonCImpl.defaultVectorAnalyticsProvider.get());
            }
          };

          case 105: // im.vector.app.features.home.room.list.home.invites.InvitesViewModel.Factory 
          return (T) new InvitesViewModel.Factory() {
            @Override
            public InvitesViewModel create(InvitesViewState initialState103) {
              return new InvitesViewModel(initialState103, singletonCImpl.session(), singletonCImpl.stringProvider(), singletonCImpl.drawableProvider());
            }
          };

          case 106: // im.vector.app.features.home.room.list.home.release.ReleaseNotesViewModel.Factory 
          return (T) new ReleaseNotesViewModel.Factory() {
            @Override
            public ReleaseNotesViewModel create(VectorDummyViewState initialState104) {
              return new ReleaseNotesViewModel(initialState104);
            }
          };

          case 107: // im.vector.app.features.settings.devices.v2.overview.SessionOverviewViewModel.Factory 
          return (T) new SessionOverviewViewModel.Factory() {
            @Override
            public SessionOverviewViewModel create(SessionOverviewViewState initialState105) {
              return new SessionOverviewViewModel(initialState105, mavericksViewModelCImpl.getDeviceFullInfoUseCase(), mavericksViewModelCImpl.checkIfCurrentSessionCanBeVerifiedUseCase(), mavericksViewModelCImpl.signoutSessionsUseCase(), mavericksViewModelCImpl.pendingAuthHandler(), singletonCImpl.activeSessionHolderProvider.get(), mavericksViewModelCImpl.toggleNotificationsUseCase(), singletonCImpl.getNotificationsStatusUseCase(), mavericksViewModelCImpl.refreshDevicesUseCase(), singletonCImpl.vectorPreferences(), mavericksViewModelCImpl.toggleIpAddressVisibilityUseCase());
            }
          };

          case 108: // im.vector.app.features.settings.devices.v2.othersessions.OtherSessionsViewModel.Factory 
          return (T) new OtherSessionsViewModel.Factory() {
            @Override
            public OtherSessionsViewModel create(OtherSessionsViewState initialState106) {
              return new OtherSessionsViewModel(initialState106, singletonCImpl.activeSessionHolderProvider.get(), mavericksViewModelCImpl.getDeviceFullInfoListUseCase(), mavericksViewModelCImpl.signoutSessionsUseCase(), mavericksViewModelCImpl.pendingAuthHandler(), mavericksViewModelCImpl.refreshDevicesUseCase(), singletonCImpl.vectorPreferences(), mavericksViewModelCImpl.toggleIpAddressVisibilityUseCase());
            }
          };

          case 109: // im.vector.app.features.settings.devices.v2.details.SessionDetailsViewModel.Factory 
          return (T) new SessionDetailsViewModel.Factory() {
            @Override
            public SessionDetailsViewModel create(SessionDetailsViewState initialState107) {
              return new SessionDetailsViewModel(initialState107, mavericksViewModelCImpl.getDeviceFullInfoUseCase(), mavericksViewModelCImpl.copyToClipboardUseCase());
            }
          };

          case 110: // im.vector.app.features.settings.devices.v2.rename.RenameSessionViewModel.Factory 
          return (T) new RenameSessionViewModel.Factory() {
            @Override
            public RenameSessionViewModel create(RenameSessionViewState initialState108) {
              return new RenameSessionViewModel(initialState108, mavericksViewModelCImpl.getDeviceFullInfoUseCase(), mavericksViewModelCImpl.renameSessionUseCase());
            }
          };

          case 111: // im.vector.app.features.settings.devices.v2.more.SessionLearnMoreViewModel.Factory 
          return (T) new SessionLearnMoreViewModel.Factory() {
            @Override
            public SessionLearnMoreViewModel create(SessionLearnMoreViewState initialState109) {
              return new SessionLearnMoreViewModel(initialState109);
            }
          };

          case 112: // im.vector.app.features.settings.labs.VectorSettingsLabsViewModel.Factory 
          return (T) new VectorSettingsLabsViewModel.Factory() {
            @Override
            public VectorSettingsLabsViewModel create(VectorSettingsLabsViewState initialState110) {
              return new VectorSettingsLabsViewModel(initialState110, singletonCImpl.activeSessionHolderProvider.get(), singletonCImpl.updateMatrixClientInfoUseCase(), mavericksViewModelCImpl.deleteMatrixClientInfoUseCase());
            }
          };

          case 113: // im.vector.app.features.attachments.AttachmentTypeSelectorViewModel.Factory 
          return (T) new AttachmentTypeSelectorViewModel.Factory() {
            @Override
            public AttachmentTypeSelectorViewModel create(
                AttachmentTypeSelectorViewState initialState111) {
              return new AttachmentTypeSelectorViewModel(initialState111, singletonCImpl.debugVectorFeatures(), singletonCImpl.vectorPreferences());
            }
          };

          case 114: // im.vector.app.features.settings.notifications.VectorSettingsNotificationViewModel.Factory 
          return (T) new VectorSettingsNotificationViewModel.Factory() {
            @Override
            public VectorSettingsNotificationViewModel create(
                VectorDummyViewState initialState112) {
              return new VectorSettingsNotificationViewModel(initialState112, singletonCImpl.pushersManager(), singletonCImpl.vectorPreferences(), mavericksViewModelCImpl.enableNotificationsForCurrentSessionUseCase(), mavericksViewModelCImpl.disableNotificationsForCurrentSessionUseCase(), singletonCImpl.unregisterUnifiedPushUseCase(), mavericksViewModelCImpl.registerUnifiedPushUseCase(), mavericksViewModelCImpl.ensureFcmTokenIsRetrievedUseCase(), mavericksViewModelCImpl.toggleNotificationsForCurrentSessionUseCase());
            }
          };

          case 115: // im.vector.app.features.settings.notifications.VectorSettingsPushRuleNotificationViewModel.Factory 
          return (T) new VectorSettingsPushRuleNotificationViewModel.Factory() {
            @Override
            public VectorSettingsPushRuleNotificationViewModel create(
                VectorSettingsPushRuleNotificationViewState initialState113) {
              return new VectorSettingsPushRuleNotificationViewModel(initialState113, singletonCImpl.session(), new GetPushRulesOnInvalidStateUseCase());
            }
          };

          case 116: // im.vector.app.features.home.room.detail.composer.link.SetLinkViewModel.Factory 
          return (T) new SetLinkViewModel.Factory() {
            @Override
            public SetLinkViewModel create(SetLinkViewState initialState114) {
              return new SetLinkViewModel(initialState114);
            }
          };

          case 117: // im.vector.app.features.roomprofile.polls.RoomPollsViewModel.Factory 
          return (T) new RoomPollsViewModel.Factory() {
            @Override
            public RoomPollsViewModel create(RoomPollsViewState initialState115) {
              return new RoomPollsViewModel(initialState115, mavericksViewModelCImpl.getPollsUseCase(), mavericksViewModelCImpl.loadMorePollsUseCase(), mavericksViewModelCImpl.syncPollsUseCase(), mavericksViewModelCImpl.disposePollHistoryUseCase(), mavericksViewModelCImpl.pollSummaryMapper());
            }
          };

          case 118: // im.vector.app.features.roomprofile.polls.detail.ui.RoomPollDetailViewModel.Factory 
          return (T) new RoomPollDetailViewModel.Factory() {
            @Override
            public RoomPollDetailViewModel create(RoomPollDetailViewState initialState116) {
              return new RoomPollDetailViewModel(initialState116, mavericksViewModelCImpl.getTimelineEventUseCase(), mavericksViewModelCImpl.roomPollDetailMapper(), mavericksViewModelCImpl.voteToPollUseCase());
            }
          };

          case 119: // im.vector.app.features.home.NewHomeDetailViewModel.Factory 
          return (T) new NewHomeDetailViewModel.Factory() {
            @Override
            public NewHomeDetailViewModel create(NewHomeDetailViewState initialState117) {
              return new NewHomeDetailViewModel(initialState117, mavericksViewModelCImpl.getSpacesNotificationBadgeStateUseCase());
            }
          };
  ...
  private static final class SingletonCImpl extends VectorApplication_HiltComponents.SingletonC {
    ...
    private Provider<Clock> providesDefaultClockProvider;
    ...
    private Provider<DefaultMdmService> defaultMdmServiceProvider;
    ...
    private Provider<PushRulesUpdater> pushRulesUpdaterProvider;
    ...
    private VectorDateFormatter vectorDateFormatter() {
      return new VectorDateFormatter(context(), defaultLocaleProvider(), dateFormatterProviders(), providesDefaultClockProvider.get());
    }
    ...
    private GoogleFcmHelper googleFcmHelper() {
      return new GoogleFcmHelper(ApplicationContextModule_ProvideContextFactory.provideContext(applicationContextModule), providesDefaultSharedPreferencesProvider.get(), providesApplicationCoroutineScopeProvider.get(), VectorStaticModule_ProvidesCoroutineDispatchersFactory.providesCoroutineDispatchers());
    }
    ...
    private UnifiedPushHelper unifiedPushHelper() {
      return new UnifiedPushHelper(context(), unifiedPushStore(), stringProvider(), providesMatrixProvider.get(), googleFcmHelper(), defaultMdmServiceProvider.get());
    }
    ...
    private NotifiableEventResolver notifiableEventResolver() {
      return new NotifiableEventResolver(stringProvider(), noticeEventFormatter(), displayableEventFormatter(), providesDefaultClockProvider.get(), providesBuildMetaProvider.get());
    }
    ...
    private UpdatePushRulesIfNeededUseCase updatePushRulesIfNeededUseCase() {
    ...
    private ConfigureAndStartSessionUseCase configureAndStartSessionUseCase() {
      return new ConfigureAndStartSessionUseCase(ApplicationContextModule_ProvideContextFactory.provideContext(applicationContextModule), webRtcCallManagerProvider.get(), updateMatrixClientInfoUseCase(), vectorPreferences(), notificationsSettingUpdaterProvider.get(), updateNotificationSettingsAccountDataUseCase(), pushRulesUpdaterProvider.get());
    }
    ...
    private VectorRoomDisplayNameFallbackProvider vectorRoomDisplayNameFallbackProvider() {
      return new VectorRoomDisplayNameFallbackProvider(context(), activeSessionHolderProvider);
    }

    private MatrixConfiguration matrixConfiguration() {
      return VectorStaticModule_ProvidesMatrixConfigurationFactory.providesMatrixConfiguration(vectorPreferences(), vectorRoomDisplayNameFallbackProvider(), vectorFlipperProxyProvider.get(), vectorPluginsProvider.get(), new VectorCustomEventTypesProvider(), defaultMdmServiceProvider.get());
    }
    ...
    private ReportedDecryptionFailurePersistence reportedDecryptionFailurePersistence() {
    ...
    private PushersManager pushersManager() {
      return new PushersManager(unifiedPushHelper(), activeSessionHolderProvider.get(), defaultLocaleProvider(), stringProvider(), defaultAppNameProvider(), defaultGetDeviceInfoUseCase(), defaultMdmServiceProvider.get());
    }
    ...
    private FirebaseNightlyProxy firebaseNightlyProxy() {
      return new FirebaseNightlyProxy(providesDefaultClockProvider.get(), providesDefaultSharedPreferencesProvider.get(), providesBuildMetaProvider.get());
    }
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      this.activeSessionDataSourceProvider = DoubleCheck.provider(new SwitchingProvider<ActiveSessionDataSource>(singletonCImpl, 2));
      this.providesDefaultClockProvider = DoubleCheck.provider(new SwitchingProvider<Clock>(singletonCImpl, 5));
      this.popupAlertManagerProvider = DoubleCheck.provider(new SwitchingProvider<PopupAlertManager>(singletonCImpl, 4));
      this.keyRequestHandlerProvider = DoubleCheck.provider(new SwitchingProvider<KeyRequestHandler>(singletonCImpl, 3));
      this.activeSessionHolderProvider = new DelegateFactory<>();
      this.matrixItemColorProvider = DoubleCheck.provider(new SwitchingProvider<MatrixItemColorProvider>(singletonCImpl, 8));
      this.avatarRendererProvider = new SwitchingProvider<>(singletonCImpl, 7);
      this.providesApplicationCoroutineScopeProvider = DoubleCheck.provider(new SwitchingProvider<CoroutineScope>(singletonCImpl, 9));
      this.incomingVerificationRequestHandlerProvider = DoubleCheck.provider(new SwitchingProvider<IncomingVerificationRequestHandler>(singletonCImpl, 6));
      this.providesBuildMetaProvider = DoubleCheck.provider(new SwitchingProvider<BuildMeta>(singletonCImpl, 12));
      this.defaultVectorAnalyticsProvider = DoubleCheck.provider(new SwitchingProvider<DefaultVectorAnalytics>(singletonCImpl, 11));
      this.providesDefaultSharedPreferencesProvider = DoubleCheck.provider(new SwitchingProvider<SharedPreferences>(singletonCImpl, 13));
      this.providesMatrixProvider = new DelegateFactory<>();
      this.defaultMdmServiceProvider = DoubleCheck.provider(new SwitchingProvider<DefaultMdmService>(singletonCImpl, 14));
      this.webRtcCallManagerProvider = DoubleCheck.provider(new SwitchingProvider<WebRtcCallManager>(singletonCImpl, 10));
      this.emojiCompatWrapperProvider = DoubleCheck.provider(new SwitchingProvider<EmojiCompatWrapper>(singletonCImpl, 16));
      this.eventHtmlRendererProvider = DoubleCheck.provider(new SwitchingProvider<EventHtmlRenderer>(singletonCImpl, 17));
      this.notificationUtilsProvider = DoubleCheck.provider(new SwitchingProvider<NotificationUtils>(singletonCImpl, 19));
      this.notificationBitmapLoaderProvider = DoubleCheck.provider(new SwitchingProvider<NotificationBitmapLoader>(singletonCImpl, 20));
      this.notificationDrawerManagerProvider = DoubleCheck.provider(new SwitchingProvider<NotificationDrawerManager>(singletonCImpl, 18));
      this.pushRuleTriggerListenerProvider = DoubleCheck.provider(new SwitchingProvider<PushRuleTriggerListener>(singletonCImpl, 15));
      this.sessionListenerProvider = DoubleCheck.provider(new SwitchingProvider<SessionListener>(singletonCImpl, 21));
      this.notificationsSettingUpdaterProvider = DoubleCheck.provider(new SwitchingProvider<NotificationsSettingUpdater>(singletonCImpl, 22));
      this.pushRulesUpdaterProvider = DoubleCheck.provider(new SwitchingProvider<PushRulesUpdater>(singletonCImpl, 23));
      DelegateFactory.setDelegate(activeSessionHolderProvider, DoubleCheck.provider(new SwitchingProvider<ActiveSessionHolder>(singletonCImpl, 1)));
      this.vectorFlipperProxyProvider = DoubleCheck.provider(new SwitchingProvider<VectorFlipperProxy>(singletonCImpl, 24));
      this.vectorPluginsProvider = DoubleCheck.provider(new SwitchingProvider<VectorPlugins>(singletonCImpl, 25));
      DelegateFactory.setDelegate(providesMatrixProvider, DoubleCheck.provider(new SwitchingProvider<Matrix>(singletonCImpl, 0)));
      this.emojiCompatFontProvider = DoubleCheck.provider(new SwitchingProvider<EmojiCompatFontProvider>(singletonCImpl, 26));
      this.vectorFileLoggerProvider = DoubleCheck.provider(new SwitchingProvider<VectorFileLogger>(singletonCImpl, 29));
      this.bugReporterProvider = DoubleCheck.provider(new SwitchingProvider<BugReporter>(singletonCImpl, 28));
      this.vectorUncaughtExceptionHandlerProvider = DoubleCheck.provider(new SwitchingProvider<VectorUncaughtExceptionHandler>(singletonCImpl, 27));
      this.spaceStateHandlerImplProvider = DoubleCheck.provider(new SwitchingProvider<SpaceStateHandlerImpl>(singletonCImpl, 30));
      this.sharedPrefPinCodeStoreProvider = DoubleCheck.provider(new SwitchingProvider<SharedPrefPinCodeStore>(singletonCImpl, 32));
      this.pinLockerProvider = DoubleCheck.provider(new SwitchingProvider<PinLocker>(singletonCImpl, 31));
      this.invitesAcceptorProvider = DoubleCheck.provider(new SwitchingProvider<InvitesAcceptor>(singletonCImpl, 33));
      this.autoRageShakerProvider = DoubleCheck.provider(new SwitchingProvider<AutoRageShaker>(singletonCImpl, 34));
      this.decryptionFailureTrackerProvider = DoubleCheck.provider(new SwitchingProvider<DecryptionFailureTracker>(singletonCImpl, 35));
      this.vectorLocaleProvider = DoubleCheck.provider(new SwitchingProvider<VectorLocale>(singletonCImpl, 36));
      this.defaultNavigatorProvider = DoubleCheck.provider(new SwitchingProvider<DefaultNavigator>(singletonCImpl, 37));
      this.emojiDataSourceProvider = DoubleCheck.provider(new SwitchingProvider<EmojiDataSource>(singletonCImpl, 38));
      this.factoryProvider = SingleCheck.provider(new SwitchingProvider<KeyStoreCrypto.Factory>(singletonCImpl, 40));
      this.lockScreenKeyRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<LockScreenKeyRepository>(singletonCImpl, 39));
      this.audioMessagePlaybackTrackerProvider = DoubleCheck.provider(new SwitchingProvider<AudioMessagePlaybackTracker>(singletonCImpl, 41));
      this.roomDetailPendingActionStoreProvider = DoubleCheck.provider(new SwitchingProvider<RoomDetailPendingActionStore>(singletonCImpl, 42));
      this.vectorHtmlCompressorProvider = DoubleCheck.provider(new SwitchingProvider<VectorHtmlCompressor>(singletonCImpl, 43));
      this.locationPinProvider = DoubleCheck.provider(new SwitchingProvider<LocationPinProvider>(singletonCImpl, 44));
      this.providesVoiceBroadcastRecorderProvider = DoubleCheck.provider(new SwitchingProvider<VoiceBroadcastRecorder>(singletonCImpl, 45));
      this.voiceBroadcastPlayerImplProvider = DoubleCheck.provider(new SwitchingProvider<VoiceBroadcastPlayerImpl>(singletonCImpl, 46));
      this.liveLocationNotificationBuilderProvider = DoubleCheck.provider(new SwitchingProvider<LiveLocationNotificationBuilder>(singletonCImpl, 47));
      this.locationTrackerProvider = DoubleCheck.provider(new SwitchingProvider<LocationTracker>(singletonCImpl, 48));
      this.reAuthHelperProvider = DoubleCheck.provider(new SwitchingProvider<ReAuthHelper>(singletonCImpl, 49));
      this.jitsiActiveConferenceHolderProvider = DoubleCheck.provider(new SwitchingProvider<JitsiActiveConferenceHolder>(singletonCImpl, 50));
      this.locationSharingServiceConnectionProvider = DoubleCheck.provider(new SwitchingProvider<LocationSharingServiceConnection>(singletonCImpl, 51));
    }
    ...
    @Override
    public Clock clock() {
      return providesDefaultClockProvider.get();
    }
    ...
    public VectorPreferences vectorPreferences() {
      return new VectorPreferences(context(), providesDefaultClockProvider.get(), providesBuildMetaProvider.get(), debugVectorFeatures(), providesDefaultSharedPreferencesProvider.get(), stringProvider());
    }
    ...
    private VectorApplication injectVectorApplication2(VectorApplication instance) {
      ...
      VectorApplication_MembersInjector.injectDecryptionFailureTracker(instance, decryptionFailureTrackerProvider.get());
      ...
      VectorApplication_MembersInjector.injectWebRtcCallManager(instance, webRtcCallManagerProvider.get());
      return instance;
    }
    ...
    private NotificationBroadcastReceiver injectNotificationBroadcastReceiver2(
      ...
      NotificationBroadcastReceiver_MembersInjector.injectClock(instance, providesDefaultClockProvider.get());
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          case 4: // im.vector.app.features.popup.PopupAlertManager 
          return (T) new PopupAlertManager(singletonCImpl.providesDefaultClockProvider.get(), singletonCImpl.stringProvider());

          case 5: // im.vector.lib.core.utils.timer.Clock 
          return (T) VectorStaticModule_ProvidesDefaultClockFactory.providesDefaultClock();

          case 6: // im.vector.app.features.crypto.verification.IncomingVerificationRequestHandler 
          return (T) new IncomingVerificationRequestHandler(singletonCImpl.context(), singletonCImpl.avatarRendererProvider, singletonCImpl.popupAlertManagerProvider.get(), singletonCImpl.providesApplicationCoroutineScopeProvider.get(), singletonCImpl.providesDefaultClockProvider.get());

          case 7: // im.vector.app.features.home.AvatarRenderer 
          return (T) new AvatarRenderer(singletonCImpl.activeSessionHolderProvider.get(), singletonCImpl.matrixItemColorProvider.get(), singletonCImpl.dimensionConverter(), singletonCImpl.stringProvider());

          case 8: // im.vector.app.features.home.room.detail.timeline.helper.MatrixItemColorProvider 
          return (T) new MatrixItemColorProvider(singletonCImpl.colorProvider());

          case 9: // kotlinx.coroutines.CoroutineScope 
          return (T) VectorStaticModule_ProvidesApplicationCoroutineScopeFactory.providesApplicationCoroutineScope();

          case 10: // im.vector.app.features.call.webrtc.WebRtcCallManager 
          ...
          case 11: // im.vector.app.features.analytics.impl.DefaultVectorAnalytics 
          ...
          case 12: // im.vector.app.core.resources.BuildMeta 
          return (T) VectorStaticModule_ProvidesBuildMetaFactory.providesBuildMeta(singletonCImpl.context());

          case 13: // @im.vector.app.core.di.DefaultPreferences android.content.SharedPreferences 
          ...
          case 14: // im.vector.app.features.mdm.DefaultMdmService 
          return (T) new DefaultMdmService(ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule));

          case 15: // im.vector.app.features.notifications.PushRuleTriggerListener 
          ...
          case 16: // im.vector.app.EmojiCompatWrapper 
          return (T) new EmojiCompatWrapper(singletonCImpl.context());

          case 17: // im.vector.app.features.html.EventHtmlRenderer 
          ...
          case 18: // im.vector.app.features.notifications.NotificationDrawerManager 
          ...
          case 19: // im.vector.app.features.notifications.NotificationUtils 
          return (T) new NotificationUtils(singletonCImpl.context(), singletonCImpl.stringProvider(), singletonCImpl.vectorPreferences(), singletonCImpl.providesDefaultClockProvider.get(), singletonCImpl.notificationActionIds(), singletonCImpl.providesBuildMetaProvider.get());

          case 20: // im.vector.app.features.notifications.NotificationBitmapLoader 
          return (T) new NotificationBitmapLoader(singletonCImpl.context());

          case 21: // im.vector.app.features.session.SessionListener 
          return (T) new SessionListener(singletonCImpl.defaultVectorAnalyticsProvider.get());

          case 22: // im.vector.app.core.notification.NotificationsSettingUpdater 
          return (T) new NotificationsSettingUpdater(singletonCImpl.updateEnableNotificationsSettingOnChangeUseCase());

          case 23: // im.vector.app.core.notification.PushRulesUpdater 
          return (T) new PushRulesUpdater(singletonCImpl.updatePushRulesIfNeededUseCase());

          case 24: // im.vector.app.flipper.VectorFlipperProxy 
          return (T) new VectorFlipperProxy(singletonCImpl.context());

          case 25: // im.vector.app.features.analytics.metrics.VectorPlugins 
          return (T) new VectorPlugins(new SentryDownloadDeviceKeysMetrics(), new SentrySyncDurationMetrics(), new SentryCryptoAnalytics());

          case 26: // im.vector.app.EmojiCompatFontProvider 
          return (T) new EmojiCompatFontProvider();

          case 27: // im.vector.app.features.rageshake.VectorUncaughtExceptionHandler 
          return (T) new VectorUncaughtExceptionHandler(singletonCImpl.providesDefaultSharedPreferencesProvider.get(), singletonCImpl.bugReporterProvider.get(), singletonCImpl.versionProvider(), singletonCImpl.versionCodeProvider(), singletonCImpl.defaultAppNameProvider());

          case 28: // im.vector.app.features.rageshake.BugReporter 
          ...
          case 29: // im.vector.app.features.rageshake.VectorFileLogger 
          return (T) new VectorFileLogger(singletonCImpl.context(), singletonCImpl.vectorPreferences());

          case 30: // im.vector.app.SpaceStateHandlerImpl 
          ...
          case 35: // im.vector.app.features.analytics.DecryptionFailureTracker 
          return (T) new DecryptionFailureTracker(singletonCImpl.defaultVectorAnalyticsProvider.get(), singletonCImpl.activeSessionDataSourceProvider.get(), singletonCImpl.reportedDecryptionFailurePersistence(), singletonCImpl.providesDefaultClockProvider.get());

          case 36: // im.vector.app.features.settings.VectorLocale 
          ...
          case 37: // im.vector.app.features.navigation.DefaultNavigator 
          return (T) new DefaultNavigator(singletonCImpl.activeSessionHolderProvider.get(), singletonCImpl.vectorPreferences(), singletonCImpl.widgetArgsBuilder(), singletonCImpl.spaceStateHandlerImplProvider.get(), singletonCImpl.supportedVerificationMethodsProvider(), singletonCImpl.debugVectorFeatures(), singletonCImpl.providesApplicationCoroutineScopeProvider.get(), singletonCImpl.defaultVectorAnalyticsProvider.get(), DebugModule_Companion_ProvidesDebugNavigatorFactory.providesDebugNavigator());

          case 38: // im.vector.app.features.reactions.data.EmojiDataSource 
          return (T) new EmojiDataSource(singletonCImpl.providesApplicationCoroutineScopeProvider.get(), singletonCImpl.resources());

          case 39: // im.vector.app.features.pin.lockscreen.crypto.LockScreenKeyRepository 
          ...
          case 40: // im.vector.app.features.pin.lockscreen.crypto.KeyStoreCrypto.Factory 
          ...
          case 41: // im.vector.app.features.home.room.detail.timeline.helper.AudioMessagePlaybackTracker 
          return (T) new AudioMessagePlaybackTracker();

          case 42: // im.vector.app.features.home.room.detail.RoomDetailPendingActionStore 
          return (T) new RoomDetailPendingActionStore();

          case 43: // im.vector.app.features.html.VectorHtmlCompressor 
          return (T) new VectorHtmlCompressor();

          case 44: // im.vector.app.features.home.room.detail.timeline.helper.LocationPinProvider 
          return (T) new LocationPinProvider(singletonCImpl.context(), singletonCImpl.dimensionConverter(), singletonCImpl.avatarRendererProvider.get(), singletonCImpl.matrixItemColorProvider.get());

          case 45: // im.vector.app.features.voicebroadcast.recording.VoiceBroadcastRecorder 
          ...
          case 46: // im.vector.app.features.voicebroadcast.listening.VoiceBroadcastPlayerImpl 
          ...
          case 47: // im.vector.app.features.location.live.tracking.LiveLocationNotificationBuilder 
          return (T) new LiveLocationNotificationBuilder(singletonCImpl.context(), singletonCImpl.stringProvider(), singletonCImpl.providesDefaultClockProvider.get(), singletonCImpl.notificationActionIds());

          case 48: // im.vector.app.features.location.LocationTracker 
          return (T) new LocationTracker(singletonCImpl.context(), singletonCImpl.activeSessionHolderProvider.get(), singletonCImpl.providesBuildMetaProvider.get(), singletonCImpl.androidPermissionChecker());

          case 49: // im.vector.app.features.login.ReAuthHelper 
          return (T) new ReAuthHelper();

          case 50: // im.vector.app.features.call.conference.JitsiActiveConferenceHolder 
          return (T) new JitsiActiveConferenceHolder(singletonCImpl.context());

          case 51: // im.vector.app.features.location.live.tracking.LocationSharingServiceConnection 
