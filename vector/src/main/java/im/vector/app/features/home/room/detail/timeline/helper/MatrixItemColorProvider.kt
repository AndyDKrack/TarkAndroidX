...
class MatrixItemColorProvider @Inject constructor(
    ...
    companion object {
        ...
        private fun getUserColorByIndex(index: Int): Int {
            return when (index % 8) {
                1 -> R.color.tark_name_02
                2 -> R.color.tark_name_03
                3 -> R.color.tark_name_04
                4 -> R.color.tark_name_05
                5 -> R.color.tark_name_06
                6 -> R.color.tark_name_07
                7 -> R.color.tark_name_08
                else -> R.color.tark_name_01
            }
        }
        ...
        private fun getColorFromRoomId(roomId: String?): Int {
            return when ((roomId?.toList()?.sumOf { it.code } ?: 0) % 3) {
                1 -> R.color.tark_room_02
                2 -> R.color.tark_room_03
                else -> R.color.tark_room_01
            }
        }
    }
}
